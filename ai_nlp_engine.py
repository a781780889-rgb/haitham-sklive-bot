...
_REQUIRED_FIELDS = [
    ...
    {'key': 'excuse_date', 'label': 'تاريخ بدء الإجازة', 'icon': '📅'},
]
...
def build_missing_prompt(data: Dict[str, Any]) -> str:
    ...
    examples = [
        ...
        '`تاريخ بدء الإجازة: اليوم`  أو  `15/5/2026`',
    ]
...
def build_smart_preview(data: Dict[str, Any], ctx: Dict = None) -> str:
    ...
    preview = (
        ...
        f'📅 *تاريخ بدء الإجازة:* {date_display}\n'
        f'🗓 *عدد الأيام:*        {duration_str}\n'
        f'📤 *تاريخ الإصدار:*     {data.get("issue_date_input", "—")}\n'
        f'⏰ *وقت الإصدار:*       {data.get("issue_time", "—")}\n'
    )
