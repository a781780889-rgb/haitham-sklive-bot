...
def _pdf(path: str, data: dict):
    ...
    row_y_offsets = {"name": -19, "nationality": -21, "employer": -22, "national_id_iqama": -22, "practitioner_name": -32, "position": -32, "visit_type": -32}
    row_x_offsets = {"national_id_iqama": 24}
